...
class Pedido {
  ...
  public function FromString($Str) {
    ...
    $DadosCartao = "dados-cartao";
    $CodigoSeguranca = "codigo-seguranca";
    $NomePortador = "nome-portador";
    ...
    $this->dadosPortadorNumero = $XML->$DadosCartao->numero;
    $this->dadosPortadorVal = $XML->$DadosCartao->validade;
    $this->dadosPortadorCodSeg = $XML->$DadosCartao->$CodigoSeguranca;
    $this->dadosPortadorInd = $XML->$DadosCartao->indicador;
    $this->dadosPortadorNome = $XML->$DadosCartao->$NomePortador;
  }
