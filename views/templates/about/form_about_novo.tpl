...
<div id="painel_basico">
  ...
  <fieldset>
    <legend>Cadastro de about</legend>  

    <form id="my_cad_form_about" name="my_cad_form_about" 
    ...
    <br>     
    <input type="button" class="btn_padrao" value="Salvar about" onclick="btn_salvar_about()"/><br/>
    <input type="button" class="btn_padrao" value="Voltar" onclick="btn_inicio_about_click()"/><br/>  
    </form>
  </fieldset>
</div>